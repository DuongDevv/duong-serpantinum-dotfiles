...
```bash
bash -c "$(curl -fsSL [https://raw.githubusercontent.com/serpantinum/master/install/install.sh](https://raw.githubusercontent.com/serpantinum/master/install/install.sh))"
